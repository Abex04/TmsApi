...
public class EnrollmentsController(IMediator mediator) : ControllerBase
{
    ...
    // Dispatches to EnrollStudentHandler via MediatR.
    // Result.Match translates typed domain errors into the right HTTP status —
    // no if/switch statements about business rules here.
    [HttpPost]
        ...
        EnrollStudentCommand command, CancellationToken ct)
    {
        ...
        return result.Match<IActionResult>(
            ...
            onFailure: error =>
            {
                ...
                // course_full / already_enrolled → 409 (conflict with current state)
